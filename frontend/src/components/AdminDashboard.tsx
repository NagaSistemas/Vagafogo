              ...
              <table className="min-w-full divide-y divide-gray-200 text-xs">
                ...
                <tbody>
                  {Object.keys(reservas).length === 0 ? (
                    <tr>
                      <td colSpan={9} className="px-2 py-3 text-gray-500 text-xs">Nenhuma reserva paga encontrada.</td>
                    </tr>
                  ) : (
                      ...
                      .map(horario => {
                        ...
                        return (
                          <React.Fragment key={horario}>
                            <tr>
                              <td colSpan={9} className="font-bold bg-gray-100 text-gray-700 px-2 py-2">
